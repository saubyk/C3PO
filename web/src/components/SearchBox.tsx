...
export function SearchBox({ value, onChange, placeholder }: Props) {
  return (
    <label className="ml-auto flex items-center gap-1.5 min-w-0 max-w-[280px] flex-1 bg-panel2 border border-line2 rounded px-2 py-1 focus-within:ring-1 focus-within:ring-accent">
